//1
console.log ('Hoi! // Nederlands'); 
console.log ('Hello! // English'); 
console.log ('مرحبا! // Arabic'); 
//2
...
console.log('the value of my variable x will be: whateverYouThinkItWillLog')
//3.3
console.log( "the value of x = 10")
//3.4
x = 10;
//3.5
console.log("the value of x is a number between 1 and 20")
//3.6
console.log(x);
...
var y = " ";
//4.1
console.log('the value of my string will be: a car brand');
//4.2
console.log(y);
//4.3
y = "toyota";
//4.4
console.log ("i think its mazda")
//4.5
console.log(y);
...
var e=[];
//6.2
console.log('i think there are sweets inside the array');
//6.3
console.log(e);
//6.4
e =["lion" , "elephant" , "dog"];
...
console.log(e);
//6.6
e.push("Daan's favorite animal ('baby pig')");
//6.7
console.log(e);
...
console.log(9 % 3, "9 % 3 remaind zero");
console.log(10 % 3, "10 % 3 remaind 1");
console.log(93 % 2, "93 % 2 remaind 1");
...
var a= 10/0;
if(p < a){
    console.log("p is less than a");
    }
    else if(p > a){
    console.log("p is greater than a");
    }else if(p === a){
    console.log(" p and a are equal");
    }else{
    console.log("can't compare p with a");
    };
